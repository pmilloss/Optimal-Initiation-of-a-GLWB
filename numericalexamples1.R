...
source("simulate_tau_gompertz.R")
...
# no surrender
VV0 <- optimal_initiation_no_surrender(nsim = nsim, X = XM[[1]], M = XM[[2]], FF = FF, basis_fun = basis_functions_2v[[3]], tau = tau, NBar = Nbar, B = B)

# early surrender
VV1 <- optimal_initiation_early_surrender(nsim = nsim, X = XM[[1]], M = XM[[2]], FF = FF, basis_fun = basis_functions_2v[[3]], tau = tau, Nbar = Nbar, B = B, penalty = penalty)
